...
class TestFormVerification(softest.TestCase): 
    ...
    @data(("Muhammad","Asad","IT","mughalasad720@gmail.com"),("Muhammad","Ali","Business","mughalasad720@gmail.com"),("Muhammad","Zubair","IT","mughalasad720@gmail.com")) # this is the test data (Note: the data must be aligned with the parameters of the function on which its implementing.
